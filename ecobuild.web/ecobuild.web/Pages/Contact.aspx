<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpages/SiteVI.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="ecobuild.Contact" %>
      ...
      <div class="iblock contact">
        ...
        <div class="form-ct">
          ...
          <p class="send">
            ...
            <img id="icp" src='/Resources/captchr.ashx?query=<%= querys() %>' alt="Mã  an toàn" />
